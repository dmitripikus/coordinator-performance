# bench11.2 — re-run of bench11.1 with EPP `--v=4` routing trace

## Purpose

The [bench11.1 mechanism analysis](../bench11.1_2Dfast_2Dslow_3P_multimedia_burst_asym_multiscorer/analysis/MECHANISM.md)
...
## Setup identical to bench11.1

Fleet, scoring profile, and workload are unchanged from bench11.1:
...
- 6-burst sweep with 60s quiesce between bursts; request-body fixes
  ...
  `stream_options.include_usage=true`) preserved from bench11.1
...
- `coord/bench_config/benchmark-job.yaml` — copy of bench11.1's (unchanged)
